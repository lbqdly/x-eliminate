...
var beginDialog = new createjs.Container();
...
beginDialog.addChild(box);

beginDialog.addEventListener("added", function () {
    show();
});
...
startbtn.addEventListener("click", function (e) {
    beginDialog.dispatchEvent("game-start");
});
